...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //final ParseGeoPoint mLocation = new ParseGeoPoint(location.getLatitude(), location.getLongitude());
        final ParseGeoPoint mLocation = new ParseGeoPoint(43.6607615, -79.3979518);
