...
//        }
    ...
    public void onConnected(Bundle bundle) {
        ...
        mLocationRequest.setInterval(10000 * 60 * 60); // Update location every second
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
                == PackageManager.PERMISSION_GRANTED) {
            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, this);
            mLastLocation = LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient);
            /*mLastLocation = new Location("My location");
            mLastLocation.setLatitude(43.6607615);
            mLastLocation.setLongitude(-79.3979518);*/
    ...
    private void doMapQuery() {
        ...
        if(myLoc == null){
            myLoc.setLatitude(43.660889);
            myLoc.setLongitude(-79.398807);
        }
